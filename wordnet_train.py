...
parser.add_argument('--gamma', type=float, default=1.0, help='temperature in the softmax')
parser.add_argument('--epsilon', type=float, default=1.0, help='adagrad/rmsprop parameter')
